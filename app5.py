...
if st.session_state.get("accent_data"):
    ...
    if data:
        ...
        # heuristic underestimates. Character/iLvl stay on auto sizing. Raid
        # columns start at index 2 (after "Character" and "iLvl").
        raid_col_widths = {
            i + 2: raid_column_width(r, raid_total_gates.get(r, 1))
